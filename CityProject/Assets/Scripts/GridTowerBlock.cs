...
namespace GRIDCITY
{
    public class GridTowerBlock : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            int x = Mathf.RoundToInt(transform.position.x + 20.01f); //these values are used in checkSlot and SetSlot from GridCityManager
            int y = Mathf.RoundToInt(transform.position.y);
            int z = Mathf.RoundToInt(transform.position.z + 20.01f);
            cityManager = GridCityManager.Instance; // static function
